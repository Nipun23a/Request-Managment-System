...
export const UpdateRequestForm: React.FC<UpdateRequestFormProps> = ({ request, onClose, onUpdate }) => {
  ...
  const handleDelete = async () => {
    if (window.confirm('Are you sure you want to delete this request?')) {
      try {
        ...
        onClose();
        // You might want to add a callback here to refresh the request list
      } catch (error) {
